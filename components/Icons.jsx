...
export const StarIcon = ({ className }) => (
  ...
  export const AgeIcon = ({ className }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
  );
  
  export const CutIcon = ({ className }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  // export const HeartSolidIcon = ({ className }) => (
  //   <svg className={className} fill="currentColor" viewBox="0 0 20 20">
  ...
  export const TranslationIcon = ({ className }) => (
    <svg className={className} viewBox="0 0 470 470" fill="currentColor">
      ...
      <path d="M401.17 68.83C356.784 24.444 297.771 0 235 0S113.216 24.444 68.83 68.83S0 172.229 0 235.001c0 46.271 13.391 90.899 38.764 129.316l-28.718 86.148c-0.898 2.695-0.197 5.667 1.812 7.676 2.009 2.008 4.979 2.708 7.676 1.812l86.15-28.716C144.102 456.609 188.729 470 235 470c62.771 0 121.784-24.444 166.17-68.83S470 297.771 470 235.001C470 172.229 445.556 113.216 401.17 68.83z M235 455c-44.491 0-87.355-13.222-123.961-38.235c-1.262-0.862-2.739-1.308-4.231-1.308c-0.797 0-1.598 0.127-2.372 0.385L29.02 440.979l25.14-75.414c0.741-2.225 0.399-4.668-0.923-6.604C28.222 322.357 15 279.492 15 235.001C15 113.692 113.691 15 235 15s220 98.692 220 220.001C455 356.309 356.309 455 235 455z"/>
    </svg>
  );