  ...
  return (
    <section id="contactUs" className="relative bg-white mt-10">
      ...
      <div className="text-center mb-12">
        ...
        <div className="w-32 h-1.5 bg-red-700 mx-auto rounded-full mt-4" />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:pr-8 xl:pr-12">
            <div className="relative rounded-2xl bg-gray-50 p-6 sm:p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6" noValidate>
                ...
                {successMessage && <div className="p-3 text-green-800 bg-green-50 rounded-lg border border-green-200">{successMessage}</div>}
                {errorMessage && <div className="p-3 text-red-800 bg-red-50 rounded-lg border border-red-200">{errorMessage}</div>}
          ...
          {/* Contact Info Column */}
          <div className="lg:pl-8 xl:pl-12 space-y-8">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg">
              ...
              {/* Address Card */}
              <div className="group bg-white rounded-xl p-6 shadow-md border border-gray-100 mb-6">
                <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4">
                  <div className="shrink-0 bg-red-700 p-4 rounded-lg shadow-sm">
                  ...
                  <div>
                    ...
                    <div className="mt-2 text-gray-600 leading-relaxed">
                      {process.env.NEXT_PUBLIC_COMPANY_ADDRESS?.split(",").map((line, index) => (
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="bg-white rounded-xl p-5 shadow-md border border-gray-100">
                  <div className="flex flex-col items-center sm:items-start text-center sm:text-left gap-3">
                    <div className="shrink-0 bg-red-700 p-3 rounded-lg">
                      <svg className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="w-full">
                      ...
                      <p className="mt-1 text-gray-600 font-medium truncate">
                        {process.env.NEXT_PUBLIC_COMPANY_PHONE}
                      </p>
                      <p className="mt-1 text-sm text-gray-400">Mon-Sat: 8AM - 7PM</p>
                    </div>
                  </div>
                </div>

                {/* Email Card - Fixed Break Point */}
                <div className="bg-white rounded-xl p-5 shadow-md border border-gray-100 overflow-hidden">
                  <div className="flex flex-col items-center sm:items-start text-center sm:text-left gap-3">
                    <div className="shrink-0 bg-red-700 p-3 rounded-lg">
                      <svg className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z" />
                    ...
                    <div className="w-full">
                      ...
                      <p className="mt-1 text-gray-600 font-medium whitespace-nowrap md:whitespace-normal xl:whitespace-nowrap break-all">
                        {process.env.NEXT_PUBLIC_COMPANY_EMAIL}
                      </p>
                      <p className="mt-1 text-sm text-gray-400">24h Response Time</p>
                    </div>
                  </div>
                </div>
              </div>
